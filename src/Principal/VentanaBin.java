 ...
 * @author
 */
public class VentanaBin extends javax.swing.JFrame {
    ...
    {   
        ...
        for (int i = 0; i < modelo.getRowCount(); i++) 
        {
            tablaValores.setValueAt(toBin(Integer.parseInt(VentanaDec.modelo.getValueAt(i,1).toString())),i,1);
        }
    }
    public static String textoABinario(String texto)
    {
        ...
        {
            textoBinario += String.format("%4s", Integer.toBinaryString(letra));
        }
    ...
    /**
     * This method is      * regenerated by the Form Editor.
called from within the constructor to initialize the form.
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registro de Memoria  (BINARIO)");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        VentanaSalida vtn=new VentanaSalida();
        vtn.setVisible(true);
    ...
    private javax.swing.JTable tablaInst;
